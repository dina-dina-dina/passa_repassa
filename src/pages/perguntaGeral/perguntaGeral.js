...
function PerguntaGeral() {
  ...
  const [botaoRecebido, setBotaoRecebido] = useState(null);
  ...
  const [imagemApertou, setImagemApertou] = useState("");
  ...
  let [universidadeBotao, setUniversidadeBotao] = useState("");
  ...
  // useEffect para setar as informações de quem apertou o botao
  useEffect(() => {
  ...
  return (
    <div class="bloco">
      <div id="topo">
        <div id="esquerda">
          <img src={Logo} alt="Logo da Rockbowl" height="100px"></img>
          <img
            src={Organizacao}
            alt="Comitê brasileiro de mecâncica das rochas"
            height="80px"
          ></img>
        </div>
        <div id="direita">
          <img src={Apoio} alt="Apoio" height="80px"></img>
          <img src={Patrocinio} alt="Patrocínio" height="80px"></img>
        </div>
      </div>
      <div id="tit">
        <h1>Jogo {jogo}</h1>
      ...
      <div class="perg">
        <p className="textoPergunta">Pergunta Geral {pergunta}</p>
      </div>
      {message === true ? (
        <div class="fim" id="fim">
          <img
            src={imagemApertou}
            alt="Participante que apertou o botão"
            height="150px"
            width="131px"
          ></img>
