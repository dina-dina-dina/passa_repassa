// Importar Estilo
import "./perguntaGeralBotao6.css"
...
function PerguntaGeralBotao6(){
    ...
    useEffect(() => {
        const imagemBase64Participante6 = localStorage.getItem('imagemSalvaParticipante6');
    ...
    return(
        ...
        <div class="perg">
            ...
            <div class="fim">
                <img src={imagemParticipante6} alt="" height="150px" width="131px"></img>
                <p>Participante 6</p>
            </div>
        </div>
    </div>
...
export default PerguntaGeralBotao6