// Importar Estilo
import "./perguntaGeralBotao5.css"
...
import Participante5 from "../../images/participante5.png"


// Em arquivo novo, lembra de importar no routes e no index
function PerguntaGeralBotao5(){
    ...
    useEffect(() => {
        const imagemBase64Participante5 = localStorage.getItem('imagemSalvaParticipante5');
    ...
    return(
        ...
        <div class="perg">
            ...
            <div class="fim">
                <img src={imagemParticipante5} alt="" height="150px" width="131px"></img>
                <p>Participante 5</p>
            </div>
        </div>
    </div>
...
export default PerguntaGeralBotao5