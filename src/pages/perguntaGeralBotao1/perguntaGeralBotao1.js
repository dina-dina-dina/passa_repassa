// Importar Estilo
import "./perguntaGeralBotao1.css"
...
function PerguntaGeralBotao1(){
    ...
    useEffect(() => {
        const imagemBase64Participante1 = localStorage.getItem('imagemSalvaParticipante1');
    ...
    return(
        ...
        <div class="perg">
            ...
            <div class="fim">
                <img src={imagemParticipante1} alt="" height="150px" width="131px"></img>
                <p>Participante 1</p>
            </div>
        </div>
    </div>
...
export default PerguntaGeralBotao1