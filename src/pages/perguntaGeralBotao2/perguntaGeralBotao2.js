// Importar Estilo
import "./perguntaGeralBotao2.css"
...
import Participante2 from "../../images/participante2.png"


// Em arquivo novo, lembra de importar no routes e no index
function PerguntaGeralBotao2(){
    ...
    useEffect(() => {
        const imagemBase64Participante2 = localStorage.getItem('imagemSalvaParticipante2');
    ...
    return(
        ...
        <div class="perg">
            ...
            <div class="fim">
                <img src={imagemParticipante2} alt="" height="150px" width="131px"></img>
                <p>Participante 2</p>
            </div>
        </div>
    </div>
...
export default PerguntaGeralBotao2