// Importar Estilo
import "./perguntaGeralBotao4.css"
...
function PerguntaGeralBotao4(){
    ...
    useEffect(() => {
        const imagemBase64Participante4 = localStorage.getItem('imagemSalvaParticipante4');
    ...
    return(
        ...
        <div class="perg">
            ...
            <div class="fim">
                <img src={imagemParticipante4} alt="" height="150px" width="131px"></img>
                <p>Participante 4</p>
            </div>
        </div>
    </div>
...
export default PerguntaGeralBotao4